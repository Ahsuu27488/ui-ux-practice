...
const OurProduct4 = () => {
  return (
    ...
    <div className="flex flex-col gap-2 justify-end">
      <h1 className="font-medium text-lg">Corology Product Set</h1>
      <div className="items-center gap-3 flex">
        <p className=" font-normal text-lg text-[#DB4444]">$500</p>
        ...
        <Image
          ...
          height={20}
        />
        <p className="font-semibold text-sm opacity-50">(145)</p>
      </div>
      </div>
