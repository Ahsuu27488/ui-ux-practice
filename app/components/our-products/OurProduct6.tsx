...
const OurProduct6 = () => {
  return (
    ...
    <div className="flex flex-col gap-2 justify-end">
      <h1 className="font-medium text-lg">Jr. Zoom Soccer Cleats</h1>
      <div className="items-center gap-3 flex">
        <p className=" font-normal text-lg text-[#DB4444]">$1160</p>
        ...
        <Image
          ...
          height={20}
        />
        <p className="font-semibold text-sm opacity-50">(35)</p>
      </div>
      </div>
      <div className="flex gap-1">
          <button className="w-7 h-7 rounded-full flex items-center justify-center border-[3px] border-transparent hover:border-black focus:border-black">
            <div className="w-4 h-4 rounded-full bg-[#EEFF61]"></div>
          </button>
          <button className="w-7 h-7 rounded-full flex items-center justify-center border-[3px] border-transparent hover:border-black focus:border-black">
