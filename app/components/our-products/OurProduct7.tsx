    ...
    <div className="w-[270px] h-[322px]">
      <div className="relative w-[270px] h-[250px]">
        <span className=" absolute rounded-[4px] w-[270px] h-[250px] top-0 bg-[#F5F5F5] group overflow-hidden">
          ...
          <h1 className="absolute bg-black font-medium flex justify-center items-center text-white py-1 w-full bottom-[-100%] group-hover:bottom-0 transition-all duration-200 ease-in-out">
            Add To Cart
          </h1>
        </span>
      </div>
      <div className="flex flex-col gap-2 justify-end">
        <h1 className="font-medium text-lg">GP11 Shooter USB Gamepad</h1>
        <div className="items-center gap-3 flex">
          ...
          <div className=" flex gap-2">
            <Image
              ...
              height={20}
            />
            <p className="font-semibold text-sm opacity-50">(95)</p>
          </div>
        </div>
        <div className="flex gap-1">
          <button className="w-7 h-7 rounded-full flex items-center justify-center border-[3px] border-transparent hover:border-black focus:border-black">
