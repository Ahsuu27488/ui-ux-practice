...
const FlashSaleProduct2 = () => {
  return (
    <div className="w-[270px] h-[350px]">
      <div className="relative w-[270px] h-[250px] group ">
        <span className=" absolute rounded-[4px] w-[270px] h-[250px] top-0 bg-[#F5F5F5] overflow-hidden">
      ...
      <div className="flex flex-col gap-2 justify-end">
        <h1 className="font-medium text-lg">AK-900 Wired Keyboard</h1>
        ...
        <div className=" flex gap-2">
          <Image
            ...
            height={20}
          />
          <p className="font-semibold text-sm opacity-50">(75)</p>
        </div>
      </div>
    </div>
  );
...
export default FlashSaleProduct2;
